...
if CUPY_AVAILABLE:
    ...
    interpolate_gauss_legendre_nodes_kernel = cp.RawKernel(
        ...
        void interpolate_gauss_legendre_nodes_kernel(
            ...
            double x4w0 = 0.0, x4w1 = 0.0, x4w2 = 0.0, x4w3 = 0.0, x4w4 = 0.0;
            double x4w5 = 0.0, x4w6 = 0.0, x4w7 = 0.0, x4w8 = 0.0;
            ...
            switch (p) {
                ...
                case 3:
                    ...
                    // w_1: 25*sqrt(3)/216
                    // w_2: -7*sqrt(3)/432
                    x1w1 = x0w4, x1w2 = x0w3, x1w3 = x0w2, x1w4 = x0w1, x1w5 = x0w0;
                ...
                case 5:
                    ...
                    x1w3 = 1067.0/960.0, x1w4 = x1w3, x1w5 = x1w2, x1w6 = x1w1;
                ...
                case 6:
                    ...
                    // third node
                    // u(x=0) = (w_-3 * U_-3) + (w_-2 * U_-2) + (w_-1 * U_-1) + (w_0 * U_0) + (w_1 * U_1) + (w_2 * U_2) + (w_3 * U_3)
                    // w_-3: -5/7168
                    // w_-2: 159/17920
                    // w_-1: -7621/107520
                    // w_0: 30251/26880
                    ...
                    // w_2: 159/17920
                    // w_3: -5/7168
                    x2w0 = -5.0/7168.0, x2w1 = 159.0/17920.0, x2w2 = -7621.0/107520.0;
                    x2w3 = 30251.0/26880.0, x2w4 = x2w2, x2w5 = x2w1, x2w6 = x2w0;
                    ...
                    x3w0 = x1w6, x3w1 = x1w5, x3w2 = x1w4, x3w3 = x1w3, x3w4 = x1w2;
                    x3w5 = x1w1, x3w6 = x1w0;
                    ...
                    x4w0 = x0w6, x4w1 = x0w5, x4w2 = x0w4, x4w3 = x0w3, x4w4 = x0w2;
                    x4w5 = x0w1, x4w6 = x0w0;

                    nquadrature = 5, reach = 3;
                    break;
                case 7:
                    // first node
                    ...
                    // w_2: 159/17920
                    // w_3: -5/7168
                    x2w0 = 0.0, x2w1 = -5.0/7168.0, x2w2 = 159.0/17920.0;
                    x2w3 = -7621.0/107520.0, x2w4 = 30251.0/26880.0;
                    x2w5 = x2w3, x2w6 = x2w2, x2w7 = x2w1, x2w8 = x2w0;
                    ...
                    x3w0 = x1w8, x3w1 = x1w7, x3w2 = x1w6, x3w3 = x1w5, x3w4 = x1w4;
                    x3w5 = x1w3, x3w6 = x1w2, x3w7 = x1w1, x3w8 = x1w0;
                    ...
                    x4w0 = x0w8, x4w1 = x0w7, x4w2 = x0w6, x4w3 = x0w5, x4w4 = x0w4;
                    x4w5 = x0w3, x4w6 = x0w2, x4w7 = x0w1, x4w8 = x0w0;

                    nquadrature = 7, reach = 4;
                    break;
            }
        }
        """
