...
class ArraySlicer:
    ...
    Args:
        ...
        groups (Optional[Dict[str, Tuple[int, ...]]]): Dictionary of group names and
            the variable names they contain.
    """
    ...
    def __post_init__(self):
        ...
        self.var_idx_map: Dict[
            str, Union[int, slice, np.ndarray[Any, np.dtype[np.int_]]]
        ] = self.variables.copy()
